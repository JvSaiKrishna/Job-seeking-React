...
export default function JobItemDetails() {
    const [jobData, setjobData] = useState({})
    const [similarJobData, setsimilarJobData] = useState([])
    const [apiStataus, setapiStataus] = useState(apiStatusConstants.initial)
    ...
    const getJobData = async () => {
        ...
        if (response.ok === true) {
            ...
            setsimilarJobData(updatedSimilarJobsData)
            setapiStataus(apiStatusConstants.success)
        } else {
            setapiStataus(apiStatusConstants.failure)
        }
    }
